package com.thoughtworks.workshoptest.integrations;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.MOCK, classes = WorkshopTestApplication.class)
